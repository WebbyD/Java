...
/*Chapter 12, Exercise 12.14 Please note that this program contains 4 classes: GuessTheNumber, ButtonListener, ButtonListener2 and ButtonListenerMain, all 
in the same Java class file. Just trying some more different Java concepts, seeing what works and what doesnt work especially in object-oriented design. 
Hopefully this will keep things simple, you know? ;}
*/
...
{
//Declaring private count variable and random number in private rand variable.
private int rand=(int) (Math.random()*1000);
private int count=0;
//Constructor.
    public GuessTheNumber ( double rand, double count )
    {
        rand = 0;
        count = 0;
    } 
//Getter and setter methods for rand.
public int getrand() 
{
