...
public class Modified_Temperature_Conversion extends JApplet implements ActionListener 
{
//This creates a new TextField, which allows the editing of a single line text. 
JTextField txtInput;
/**This creates a JLabel instance with no image and with an empty string for the title and is used to display a single line of read only text. The text 
...
@Override
/**The init method is the first method called in an Applet or JApplet. When an applet is loaded by the Java plugin of a browser or by 
 *an applet viewer, it will first call the Applet.init method.
 */
public void init()
{
...
conpane.add(button);
lblResult= new JLabel ("Hello!! Please enter your Fahrenheit temperature, choose an option to convert and then click OK.");
